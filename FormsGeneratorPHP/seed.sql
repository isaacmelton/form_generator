...
CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL UNIQUE, person_id INT NOT NULL UNIQUE, password VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id));
