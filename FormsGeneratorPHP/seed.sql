...
CREATE TABLE people (id INT AUTO_INCREMENT NOT NULL UNIQUE, first_name VARCHAR(50), last_name VARCHAR(50), email VARCHAR(100), city VARCHAR(100), state VARCHAR(100), country VARCHAR(100), sex VARCHAR(10), created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (id));
...
CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL UNIQUE, person_id INT NOT NULL UNIQUE, password VARCHAR(100) NOT NULL, created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (id), FOREIGN KEY (person_id) REFERENCES people (id));
