...
CREATE TABLE people (id INT AUTO_INCREMENT NOT NULL UNIQUE, first_name VARCHAR(50), last_name VARCHAR(50), email VARCHAR(100) UNIQUE NOT NULL, city VARCHAR(100), state VARCHAR(100), country VARCHAR(100), sex VARCHAR(10), created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (id));
...
CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL UNIQUE, person_id INT NOT NULL UNIQUE, password VARCHAR(100) NOT NULL, remember_me VARBINARY(255), created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (id), FOREIGN KEY (person_id) REFERENCES people (id));
INSERT INTO users VALUES
(4, 1, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(5, 2, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(6, 3, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(7, 4, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(8, 5, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(9, 6, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(10, 7, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(11, 8, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(12, 9, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182');
INSERT INTO users VALUES
(13, 10, '$2y$10$WX4qDDdGVpYlML1PCHf9De.AFxQxu8oEkQ.9G8AKba2jAFRT/5Xj6',NULL,'2015-06-23 16:13:50.882182','2015-06-23 16:13:50.882182'); 


CREATE TABLE surveys (id INT AUTO_INCREMENT NOT NULL UNIQUE, created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, person_id INT, title VARCHAR(100), active BOOLEAN NOT NULL, PRIMARY KEY (id), FOREIGN KEY (person_id) REFERENCES people (id));
...
CREATE TABLE questions (id INT AUTO_INCREMENT NOT NULL UNIQUE, sequence INT NOT NULL, question VARCHAR(255), created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, survey_id INT, PRIMARY KEY (id), FOREIGN KEY (survey_id) REFERENCES surveys (id));
...
CREATE TABLE answers (id INT AUTO_INCREMENT NOT NULL UNIQUE, sequence INT NOT NULL, answer VARCHAR(150), created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, question_id INT NOT NULL, PRIMARY KEY (id), FOREIGN KEY (question_id) REFERENCES questions (id));
...
CREATE TABLE recorded_answers (id INT AUTO_INCREMENT NOT NULL UNIQUE, user_id INT, answer_id INT, survey_id INT, created_at TIMESTAMP DEFAULT '0000-00-00 00:00:00', updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (id), FOREIGN KEY (answer_id) REFERENCES answers (id), FOREIGN KEY (user_id) REFERENCES people (id));
