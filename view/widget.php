...
$(document).ready(function() {
    $(function() {
        $("#forms_generator_survey").on("submit", function(e) {
            e.preventDefault();
            $.ajax({
                url: "http://45.55.93.140/util/process_widget.php",
                type: 'POST',
                data: $("#forms_generator_survey").serialize(),
                beforeSend: function() {
...
<div id="the_widget_area">
    <form id="forms_generator_survey" name="widget_survey" action="" method="post">
        <table>
            <tr>
